<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="Edge.aspx.cs" Inherits="Ford.Edge" %>
<asp:Content ID="Content1" ContentPlaceHolderID="BodyContentPlaceHolder" runat="server">
    <div class="container-fluid">
            <div class="jumbotron" style="background: transparent !important">

                <h1 style="text-align: center;">Our Star SUV</h1>

                <img id="imgEdge" src="Pictures/Edge/Edge_GB.png" alt="Edge" />
                <h3 style="text-align: center;"><strong>Choose your Skin</strong></h3>
                <div id="colorEdge" style="text-align:center;">
                    <input type="image" class="img-rounded" src="Pictures/Edge/Color_GB.PNG" onclick="document.getElementById('imgEdge').src = 'Pictures/Edge/Edge_GB.png'; return false;" />
                    <input type="image" class="img-rounded" src="Pictures/Edge/Color_IS.PNG" onclick="document.getElementById('imgEdge').src = 'Pictures/Edge/Edge_IS.png'; return false;" />
                    <input type="image" class="img-rounded" src="Pictures/Edge/Color_KB.PNG" onclick="document.getElementById('imgEdge').src = 'Pictures/Edge/Edge_KB.png'; return false;" />
                    <input type="image" class="img-rounded" src="Pictures/Edge/Color_MG.PNG" onclick="document.getElementById('imgEdge').src = 'Pictures/Edge/Edge_MG.png'; return false;" />
                    <input type="image" class="img-rounded" src="Pictures/Edge/Color_OW.PNG" onclick="document.getElementById('imgEdge').src = 'Pictures/Edge/Edge_OW.png'; return false;" />
                    <input type="image" class="img-rounded" src="Pictures/Edge/Color_SB.PNG" onclick="document.getElementById('imgEdge').src = 'Pictures/Edge/Edge_SB.png'; return false;" />
                    </div>
