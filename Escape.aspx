<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="Escape.aspx.cs" Inherits="Ford.Escape" %>
<asp:Content ID="Content1" ContentPlaceHolderID="BodyContentPlaceHolder" runat="server">
    <div class="container-fluid">
            <div class="jumbotron" style="background: transparent !important">

                <h1 style="text-align: center;">Escape the Traffic with our Comapct SUV.</h1>

                <img id="imgEscape" src="Pictures/Escape/Escape_CR.png" alt="Escape" />
                <h3 style="text-align: center;"><strong>Choose your Skin</strong></h3>
                <div id="colorEscape" style="text-align:center;">
                    <input type="image" class="img-rounded" src="Pictures/Escape/Color_CR.PNG" onclick="document.getElementById('imgEscape').src = 'Pictures/Escape/Escape_CR.png'; return false;" />
                    <input type="image" class="img-rounded" src="Pictures/Escape/Color_IS.PNG" onclick="document.getElementById('imgEscape').src = 'Pictures/Escape/Escape_IS.png'; return false;" />
                    <input type="image" class="img-rounded" src="Pictures/Escape/Color_LB.PNG" onclick="document.getElementById('imgEscape').src = 'Pictures/Escape/Escape_LB.png'; return false;" />
                    <input type="image" class="img-rounded" src="Pictures/Escape/Color_MG.PNG" onclick="document.getElementById('imgEscape').src = 'Pictures/Escape/Escape_MG.png'; return false;" />
                    <input type="image" class="img-rounded" src="Pictures/Escape/Color_OW.PNG" onclick="document.getElementById('imgEscape').src = 'Pictures/Escape/Escape_OW.png'; return false;" />
                    <input type="image" class="img-rounded" src="Pictures/Escape/Color_SB.PNG" onclick="document.getElementById('imgEscape').src = 'Pictures/Escape/Escape_SB.png'; return false;" />
                    <input type="image" class="img-rounded" src="Pictures/Escape/Color_WG.PNG" onclick="document.getElementById('imgEscape').src = 'Pictures/Escape/Escape_WG.png'; return false;" />
                    </div>
