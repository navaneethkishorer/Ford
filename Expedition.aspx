<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="Expedition.aspx.cs" Inherits="Ford.Expedition" %>
<asp:Content ID="Content1" ContentPlaceHolderID="BodyContentPlaceHolder" runat="server">
    <div class="container-fluid">
            <div class="jumbotron" style="background: transparent !important">

                <h1 style="text-align: center;">The SUV for your Long Road Trips.</h1>

                <img id="imgExpedition" src="Pictures/Expedition/Expedition_BF.png" alt="CMax" />
                <h3 style="text-align: center;"><strong>Choose your Skin</strong></h3>
                <div id="colorExpedition" style="text-align:center;">
                    <input type="image" class="img-rounded" src="Pictures/Expedition/Color_BF.PNG" onclick="document.getElementById('imgExpedition').src = 'Pictures/Expedition/Expedition_BF.png'; return false;" />
                    <input type="image" class="img-rounded" src="Pictures/Expedition/Color_BJ.PNG" onclick="document.getElementById('imgExpedition').src = 'Pictures/Expedition/Expedition_BJ.png'; return false;" />
                    <input type="image" class="img-rounded" src="Pictures/Expedition/Color_IS.PNG" onclick="document.getElementById('imgExpedition').src = 'Pictures/Expedition/Expedition_IS.png'; return false;" />
                    <input type="image" class="img-rounded" src="Pictures/Expedition/Color_MG.PNG" onclick="document.getElementById('imgExpedition').src = 'Pictures/Expedition/Expedition_MG.png'; return false;" />
                    <input type="image" class="img-rounded" src="Pictures/Expedition/Color_OW.PNG" onclick="document.getElementById('imgExpedition').src = 'Pictures/Expedition/Expedition_OW.png'; return false;" />
                    <input type="image" class="img-rounded" src="Pictures/Expedition/Color_RR.PNG" onclick="document.getElementById('imgExpedition').src = 'Pictures/Expedition/Expedition_RR.png'; return false;" />
                    <input type="image" class="img-rounded" src="Pictures/Expedition/Color_SB.PNG" onclick="document.getElementById('imgExpedition').src = 'Pictures/Expedition/Expedition_SB.png'; return false;" />
                    <input type="image" class="img-rounded" src="Pictures/Expedition/Color_WG.PNG" onclick="document.getElementById('imgExpedition').src = 'Pictures/Expedition/Expedition_WG.png'; return false;" />
                    <input type="image" class="img-rounded" src="Pictures/Expedition/Color_WP.PNG" onclick="document.getElementById('imgExpedition').src = 'Pictures/Expedition/Expedition_WP.png'; return false;" />
                    </div>
