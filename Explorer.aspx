<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="Explorer.aspx.cs" Inherits="Ford.Explorer" %>
<asp:Content ID="Content1" ContentPlaceHolderID="BodyContentPlaceHolder" runat="server">
    <div class="container-fluid">
            <div class="jumbotron" style="background: transparent !important">

                <h1 style="text-align: center;">Explore Confidently with the all new EXPLORER.</h1>

                <img id="imgExplorer" src="Pictures/Explorer/Explorer_BJ.png" alt="CMax" />
                <h3 style="text-align: center;"><strong>Choose your Skin</strong></h3>
                <div id="colorExplorer" style="text-align:center;">
                    <input type="image" class="img-rounded" src="Pictures/Explorer/Color_BJ.PNG" onclick="document.getElementById('imgExplorer').src = 'Pictures/Explorer/Explorer_BJ.png'; return false;" />
                    <input type="image" class="img-rounded" src="Pictures/Explorer/Color_IS.PNG" onclick="document.getElementById('imgExplorer').src = 'Pictures/Explorer/Explorer_IS.png'; return false;" />
                    <input type="image" class="img-rounded" src="Pictures/Explorer/Color_OW.PNG" onclick="document.getElementById('imgExplorer').src = 'Pictures/Explorer/Explorer_OW.png'; return false;" />
                    <input type="image" class="img-rounded" src="Pictures/Explorer/Color_RR.PNG" onclick="document.getElementById('imgExplorer').src = 'Pictures/Explorer/Explorer_RR.png'; return false;" />
                    <input type="image" class="img-rounded" src="Pictures/Explorer/Color_SB.PNG" onclick="document.getElementById('imgExplorer').src = 'Pictures/Explorer/Explorer_SB.png'; return false;" />
                    </div>
